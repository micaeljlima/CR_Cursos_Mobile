 ...
 * type: string
 * 400:
 * description: Requisição inválida (campos faltando, email inválido, etc.).
 * 401:
 ...
 * tags: [Professor]
 * description: Endpoint para obter a lista completa de professores. Requer permissões de administrador.
 * security:
 * - bearerAuth: []
 * responses:
 * 200:
 ...
 * tags: [Professor]
 * description: Endpoint para obter um professor específico. O usuário deve ser o próprio professor ou um administrador.
 * security:
 * - bearerAuth: []
 * parameters:
 * - in: path
 ...
 * tags: [Professor]
 * description: Endpoint para atualizar os dados de um professor. O usuário deve ser o próprio professor ou um administrador.
 * security:
 * - bearerAuth: []
 * parameters:
 * - in: path
 ...
 * 400:
 * description: Requisição inválida (email ou data de nascimento inválidos).
 * 401:
 * description: Não autorizado.
 * 403:
 ...
 * tags: [Professor]
 * description: Endpoint para deletar um professor. Requer permissões de administrador.
 * security:
 * - bearerAuth: []
 * parameters:
 * - in: path
